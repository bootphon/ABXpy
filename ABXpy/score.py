...
def score(task_file, distance_file, score_file=None, score_group='scores'):
    ...
    if score_file is None:
        ...
        score_file = basename_task + '_' + basename_dist + '.'
...
if __name__ == '__main__': # detects whether the script was called from command-line
    ...
    parser = argparse.ArgumentParser(usage="%(prog)s task distance [score]", description ='ABX score computation')
    ...
    g1.add_argument('task', help='task file generated by the task module, containing the triplets and the pairs associated to the task specification')
    g1.add_argument('distance', help='distance file generated by the distance package, containing the distance between the pairs of a task')
    g1.add_argument('score', nargs='?', default=None, help='optional: score file, where the results of the computation will be put')
