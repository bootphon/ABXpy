...
# this should allow not having __init__.py in every subfolder"""This package contains the operations necessary to initialize, calculate and
analyse the results of an ABX discrimination task.
...
| In           | Module   | Out          |
+==============+==========+==============+
| - wav files  | features | - data.feat  |
+--------------+----------+--------------+
| - data.item  | task     | - data.abx   |
+--------------+----------+--------------+
| - data.abx   | distance | - data.dist  |
| - data.feat  |          |              |
+--------------+----------+--------------+
| - data.abx   | score    | - data.score |
| - data.dist  |          |              |
